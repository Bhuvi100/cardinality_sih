            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full md:w-full mt-3 px-3 mb-6">
                ...
                <select class=" text-sm rounded-lg border border-gray-400 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:text-black  ">
                  ...
                  <option>Enquiry</option> <option>Grievance</option>{" "}
                  <option>Complaint</option>
                  <option>Appreciation</option>{" "}
                  <option>Required Support</option>{" "}
                  <option>Willing to Support</option>
                </select>
              </div>
              <div class="w-full md:w-full px-3 mb-2">
                <label class="block mb-1 text-sm font-bold text-black">
                  APPLICATION NUMBER
                </label>
                <input
                  class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 focus:ring-blue-500 focus:border-blue-500 leading-tight focus:outline-none"
                  type="text"
                  required
                />
              </div>
              ...
              <div class="w-full md:w-full px-3 mb-2">
                ...
                <select class=" text-sm rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-100  dark:text-black  ">
                  ...
                  <option>Login Credentials Related</option>
                  <option>PG Application form unable to submit</option>
                  <option>Failed Transaction</option>{" "}
                  <option>Fellowship Related</option>{" "}
                  <option>Any Technical Queries</option>{" "}
                  <option>An Non-Technical Queries</option>{" "}
              ...
              <div class="w-full md:w-full px-3 mb-2">
                ...
                <textarea
                  id="message"
                  rows="2"
                  class="block p-2.5 w-full text-sm text-gray-500 rounded-lg border border-black focus:ring-blue-500   dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:border-blue-600 focus:outline-none"
              ...
              <div class="w-full md:w-full px-3 mb-3">
                ...
                <textarea
                  ...
                  rows="10"
                  class="block p-2.5 w-full text-sm text-gray-500 rounded-lg border border-black focus:ring-blue-500   dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:border-blue-600 focus:outline-none"
                  placeholder="Description (Upto 1000 Characters)"
                ></textarea>
              </div>
              <div class="w-full md:w-full px-3 mb-2">
                <label
                  ...
                  for="small_size"
                >
                  File related to Query,if any: (less than 1Mb)(.png/.jpg/.jpeg)
                </label>
                <input
                  class="block mb-5 w-full text-xs text-gray-900 rounded-lg border border-blue-800 cursor-pointer dark:text-gray-400 focus:outline-none  dark:placeholder-gray-400"
                  id="small_size"
                  type="file"
                />
              </div>
              ...
              <div class="w-full flex items-center justify-between px-3 mb-2 ">
                <label class="flex items-center">
                  ...
                  <h4 class="text-sm font-bold text-red-700 pt-1">
