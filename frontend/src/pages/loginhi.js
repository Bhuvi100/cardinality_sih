...
export default function LoginHi() {
  ...
  return (
    <div>
      <div class="h-screen flex">
        ...
        >
          <h1 class="text-gray-800 font-bold text-4xl mb-2">लॉग इन</h1>
          <p class="text-md font-normal text-gray-600 mb-7">स्वागत</p>
          <div className="md:mb-2">
            ...
            <div className="mt-1 relative rounded-lg shadow-sm">
              ...
              <input
                id="username"
                className="block pr-10 shadow appearance-none border-2 hover:border-blue-500 rounded-lg w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 transition duration-500 ease-in-out"
          ...
          <div className="md:mb-2">
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                id="password"
                type="password"
                className="block pr-10 shadow appearance-none border-2 hover:border-blue-500 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 transition duration-500 ease-in-out"
          ...
          <div className="mb-4">
            <div className="md:ml-32">
              <a
                className="font-normal text-sm text-blue-500 hover:text-red-500"
          ...
          <button
            class="block w-40 bg-blue-500 mt-2 py-2 rounded-2xl text-white font-semibold mb-1 hover:shadow-xl"
            type="submit"
          >
            लॉग इन
          </button>
          ...
          <div className="flex space-x-1 mt-3 ">
            <p className="text-sm font-normal text-gray-500 mr-1">खाता नहीं?</p>
            <a
              className="font-semibold text-sm text-blue-500 hover:text-red-500"
              href="/register"
            >
              पंजीकरण करवाना
            </a>
