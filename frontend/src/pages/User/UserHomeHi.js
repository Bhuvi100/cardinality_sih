...
export default function UserHomeHi() {
      ...
      {search == true ? (
        <div>
          <div className="mt-8 ml-2 md:pl-8">
            <h1 className="text-xl title text-[#273339] mb-2">सुझाए गए विषय</h1>
          ...
          <div className="mt-8 pl-8">
            <h1 className="text-xl title text-[#273339]">इसी तरह की शिकायत</h1>
