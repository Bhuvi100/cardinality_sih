...
import UserHomeTa from "./UserHomeTa";

export default function UserDashboardTa() {
                ...
                <ul class="pt-8 space-y-3">
                  <li>
                    ...
                    >
                      ...
                      <span class="text-xl  hidden md:block">வீடு</span>
                    </button>
                  </li>
                  <li>
                    <button
                    ...
                    >
                      ...
                      <span class="text-xl hidden md:block">என் கேள்விகள்</span>
                    </button>
                  </li>
                  <li>
                    <button
