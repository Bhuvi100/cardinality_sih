...
export default function InstitutePGScholarship(){
...
<div class="w-full mb-6 lg:w-[100%] xl:w-[80%] 2xl:w-[85%] ml-16 md:ml-60">
    <NavBar currentMenu="PG Scholarship"/>
...
<main class="flex min-h-screen justify-center p-5">
  ...
  <h1 class="font-bold text-2xl p-3">Student Import</h1>
...
<nav class="bg-blue-400 mt-2">
    <div class="py-3 px-4">
        <div class="flex">
            <h1 class="font-medium text-white">Attachment</h1>
            <h1 class="font-medium text-white ml-2 ">Size(in bytes)</h1>
                        <h1 class="font-medium text-white ml-2 ">Type</h1>
                                    <h1 class="font-medium text-white ml-5 ">Modified</h1>
                                            </div>
    </div>
</nav>
...
<h1 class="font-bold text-2xl p-3 mt-8">Academic Details</h1>
  <div class="relative mb-3">
  <div class="absolute inset-0 flex items-center">
    <div class="w-full border-b border-blue-400 border-4"></div>
  </div>
...
<nav class="bg-blue-400 mt-2">
    <div class="py-3 px-4">
        <div class="flex">
            <h1 class="font-medium text-white">Exam</h1>
            <h1 class="font-medium text-white ml-3 ">Enter if Any(% Marks )</h1>
                        <h1 class="font-medium text-white ml-3 ">Mode</h1>
                                    <h1 class="font-medium text-white ml-2 ">Year of Passing</h1>
                                            </div>
    </div>
</nav>
<div class="flex justify-center mt-12">
