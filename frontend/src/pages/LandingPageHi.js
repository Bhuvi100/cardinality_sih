        ...
        <div class="leading-normal tracking-normal text-white gradient">
            ...
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-3">
              ...
              >
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                  <li class="mr-3">
                    <a
                      class="inline-block text-black no-underline hover:text-white hover:font-bold py-2 px-4"
                      href="#"
                    >
                      संपर्क करना
                    </a>
                ...
                <button class="mr-2 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-3 px-5 shadow-lg opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          ...
          <div class="pt-24">
            <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              <div class="flex flex-col md:w-2/5 justify-center items-start text-center md:text-left">
                <div className="md:ml-16 ">
                  ...
                  <p class="leading-normal text-xl italic mt-4">
                    प्रश्न सबमिट करें और समस्याओं का समाधान करें
                  </p>
                  <div className="flex flex-row gap-2">
                    <button
                      ...
                      onClick={() => setLogin(1)}
                    >
                      <a href="/register">पंजीकरण करवाना</a>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-3/5">
                <img
                  class="logpic md:w-5/6 md:mt-10 md:ml-36 z-50"
                  src={landing}
                />
              </div>
            </div>
